...
const chars = [
    ...
    { id: "ramirez" as const, name: "Ramirez", img: "/ramirez.png", desc: "Gt./Cho." },
...
export function CharSelectScreen({ onSelect }: CharSelectScreenProps) {
    ...
    return (
        ...
        >
            ...
            <div className="flex flex-wrap gap-2 md:gap-4 items-center justify-center w-full max-w-5xl px-4">
                {chars.map((char, i) => {
                    ...
                    return (
                        <div
                            ...
                            style={{
                                border: `4px solid ${isSelected ? "#00e5ff" : "#ffffff33"}`,
                        ...
                        >
                            <div style={{ height: "120px", display: "flex", alignItems: "flex-end", marginBottom: "20px" }}>
                                <img
                                    src={char.img}
                                    alt={char.name}
                                    style={{
                                        ...
                                        filter: isSelected ? "drop-shadow(0 0 10px #00e5ff)" : "brightness(0.5)",
                                    }}
                                />
                            </div>
                            <div
